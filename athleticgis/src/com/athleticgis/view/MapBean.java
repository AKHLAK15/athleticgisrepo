...
//        polylineModel.addOverlay(polyline);  
    ...
    public MapModel getPolylineModel() {  
        ...
        polyline.setStrokeColor("#FF0000");  
        polyline.setStrokeOpacity(1.0); 
    	List<ActivityPoint> activityPoints = AthleticgisFacade.findActivityPointsByActivityId(Long.parseLong(activityId));
    	for(ActivityPoint ap : activityPoints) {
    		polyline.getPaths().add(new LatLng(ap.getLatitude(),ap.getLongitude()));
    	}
    	polylineModel.addOverlay(polyline); 
